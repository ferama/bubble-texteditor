...
func DefaultStyles() (Style, Style) {
	focused := Style{
		...
		LineTilde:        lipgloss.NewStyle().Foreground(lipgloss.AdaptiveColor{Light: "249", Dark: "8"}),
	...
	blurred := Style{
		...
		EndOfBuffer:      lipgloss.NewStyle().Foreground(lipgloss.AdaptiveColor{Light: "254", Dark: "0"}),
		LineTilde:        lipgloss.NewStyle().Foreground(lipgloss.AdaptiveColor{Light: "249", Dark: "7"}),
		Placeholder:      lipgloss.NewStyle().Foreground(lipgloss.Color("240")),
		Prompt:           lipgloss.NewStyle().Foreground(lipgloss.Color("7")),
